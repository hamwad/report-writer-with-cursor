...
export function Environment(name: string): BaseURL {
  return `https://${name}-report-writer-with-cursor.encr.app`
}
...
/**
 * Client is an API client for the report-writer-with-cursor Encore application.
 */
...
export namespace users {
  ...
  export class ServiceClient {
     ...
     * Delete user by id
     */
    public async destroy(id: string): Promise<Response> {
      // Now make the actual call to the API
     ...
     * Get all users data
     */
    public async list(params: { page: number; limit: number }): Promise<UserResponse> {
...
class BaseClient {
  ...
  constructor(baseURL: string, options: ClientOptions) {
    ...
    if (typeof window === 'undefined') {
      this.headers['User-Agent'] = 'report-writer-with-cursor-Generated-TS-Client (Encore/v1.46.10)'
    }
