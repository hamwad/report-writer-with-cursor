...
export function Environment(name: string): BaseURL {
    return `https://${name}-pooley-report-writer-aq52.encr.app`
}
...
/**
 * Client is an API client for the pooley-report-writer-aq52 Encore application.
 */
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "pooley-report-writer-aq52-Generated-TS-Client (Encore/v1.46.10)";
        }
